...
public class DeltaBansConstants
{
  ...
  {
    public static final String CREATE_BAN_TABLE =
      ...
      " INDEX (`name`)," +
      " INDEX (`ip`));";
    public static final String CREATE_WARNING_TABLE =
      ...
      " `createdAt` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP," +
      " INDEX (`name`));";
    public static final String CREATE_RANGE_BAN_TABLE =
    ...
    public static final String SELECT_ALL_BANS_STATEMENT =
      "SELECT * FROM deltabans_bans;";
    public static final String ADD_BAN_ENTRY_STATEMENT =
      " INSERT INTO deltabans_bans" +
      " (name, ip, banner, message, duration, createdAt)" +
      " VALUES (?,?,?,?,?,?);";
    public static final String DELETE_BAN_ENTRY_NO_NULL_STATEMENT =
      " DELETE FROM deltabans_bans" +
      " WHERE name = ? AND ip = ? AND banner = ? AND message = ?" +
      " LIMIT 1;";
    public static final String DELETE_BAN_ENTRY_NAME_NULL_STATEMENT =
      " DELETE FROM deltabans_bans" +
      " WHERE name is NULL AND ip = ? AND banner = ? AND message = ?" +
      " LIMIT 1;";
    public static final String DELETE_BAN_ENTRY_IP_NULL_STATEMENT =
      " DELETE FROM deltabans_bans" +
      " WHERE name = ? AND ip is NULL AND banner = ? AND message = ?" +
      " LIMIT 1;";

    public static final String SELECT_ALL_RANGEBANS_STATEMENT =
      "SELECT * FROM deltabans_rangebans;";
    public static final String ADD_RANGEBAN_ENTRY_STATEMENT =
      " INSERT INTO deltabans_rangebans" +
      " (ip_start, ip_end, banner, message, createdAt)" +
      " VALUES (?,?,?,?,?);";
    public static final String DELETE_RANGEBAN_ENTRY_STATEMENT =
      " DELETE FROM deltabans_rangebans" +
      " WHERE ip_start = ? AND ip_end = ? AND banner = ? AND message = ?" +
      " LIMIT 1;";

    public static final String SELECT_ALL_WARNINGS_STATEMENT =
      "SELECT * FROM deltabans_warnings;";
    public static final String ADD_WARNING_STATEMENT =
      " INSERT INTO deltabans_warnings" +
      " (name, warner, message, createdAt)" +
      " VALUES (?,?,?,?);";
    public static final String DELETE_WARNING_STATEMENT =
      " DELETE FROM deltabans_warnings" +
      " WHERE name = ? AND warner = ? AND message = ?" +
      " LIMIT 1;";

    public static final String SELECT_ALL_WHITELIST_STATEMENT =
      "SELECT * FROM deltabans_whitelist;";
    public static final String ADD_TO_WHITELIST_STATEMENT =
      " INSERT INTO deltabans_whitelist" +
      " (name, type)" +
      " VALUES (?,?);";
    public static final String DELETE_FROM_WHITELIST_STATEMENT =
      " DELETE FROM deltabans_whitelist" +
      " WHERE name = ?";
    public static final String UPDATE_IN_WHITELIST_STATEMENT =
